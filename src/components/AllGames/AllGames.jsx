    ...
    <>
      <div className="grid-cols-1 grid gap-4">
        {displayedGames.map((game) => (
          <div
            key={game.id}
            className="bg-midnight text-ivory p-4 rounded-lg flex flex-col gap-2">
            <div className="flex flex-row gap-2">
              ...
              <div className="flex flex-row justify-between gap-2 w-full items-center">
                ...
                <button
                  className="bg-rosy text-ivory px-4 py-2 rounded-lg hover:bg-pine transition-all duration-200"
